...
namespace MySite.AppData
{
    ...
    public class MyArts
    {
        ...
        { 
          ...
          {
              ID = 40,
              URL = BASEPATH + "/MyArt/40/Lia-Sticky-Note-Art",
              SITE_URL = "/MyArt/43/Lia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 41,
              URL = BASEPATH + "/MyArt/41/Alice-Sticky-Note-Art",
              SITE_URL = "/MyArt/41/Alice-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 42,
              URL = BASEPATH + "/MyArt/42/Blossom-Sticky-Note-Art",
              SITE_URL = "/MyArt/42/Blossom-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 43,
              URL = BASEPATH + "/MyArt/43/Little-Princess-Sticky-Note-Art",
              SITE_URL = "/MyArt/43/Little-Princess-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 44,
              URL = BASEPATH + "/MyArt/44/Astro-Love-Sticky-Note-Art",
              SITE_URL = "/MyArt/44/Astro-Love-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 45,
              URL = BASEPATH + "/MyArt/45/Freedom-Sticky-Note-Art",
              SITE_URL = "/MyArt/45/Freedom-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 46,
              URL = BASEPATH + "/MyArt/46/Rapunzel-Sticky-Note-Art",
              SITE_URL = "/MyArt/46/Rapunzel-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 47,
              URL = BASEPATH + "/MyArt/47/Unveiling-Beauty-Sticky-Note-Art",
              SITE_URL = "/MyArt/47/Unveiling-Beauty-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",

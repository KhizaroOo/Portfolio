...
namespace MySite.AppData
{
    ...
    public class MyArts
    {
        ...
        { 
          ...
          {
              ID = 19,
              URL = BASEPATH + "/MyArt/19/Tree-House-Sticky-Note-Art",
              SITE_URL = "/MyArt/19/Tree-House-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 20,
              URL = BASEPATH + "/MyArt/20/Above-Earth-Sticky-Note-Art",
              SITE_URL = "/MyArt/20/Above-Earth-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 21,
              URL = BASEPATH + "/MyArt/21/Fulgent-Life-Sticky-Note-Art",
              SITE_URL = "/MyArt/21/Fulgent-Life-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 22,
              URL = BASEPATH + "/MyArt/22/Nature-Excavation-Sticky-Note-Art",
              SITE_URL = "/MyArt/22/Nature-Excavation-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 23,
              URL = BASEPATH + "/MyArt/23/Cats-Sticky-Note-Art",
              SITE_URL = "/MyArt/23/Cats-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 24,
              URL = BASEPATH + "/MyArt/24/Long-Distance-Relationships-Sticky-Note-Art",
              SITE_URL = "/MyArt/24/Long-Distance-Relationships-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 25,
              URL = BASEPATH + "/MyArt/25/The-Rose-Enchanted-Sticky-Note-Art",
              SITE_URL = "/MyArt/25/The-Rose-Enchanted-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 26,
              URL = BASEPATH + "/MyArt/26/The-Thorny-Beauty-Sticky-Note-Art",
              SITE_URL = "/MyArt/26/The-Thorny-Beauty-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 27,
              URL = BASEPATH + "/MyArt/27/Beach-Beauty-Sticky-Note-Art",
              SITE_URL = "/MyArt/27/Beach-Beauty-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 28,
              URL = BASEPATH + "/MyArt/28/Big-Bang-Theory-Sticky-Note-Art",
              SITE_URL = "/MyArt/28/Big-Bang-Theory-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 29,
              URL = BASEPATH + "/MyArt/29/Sophia-Sticky-Note-Art",
              SITE_URL = "/MyArt/29/Sophia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 30,
              URL = BASEPATH + "/MyArt/30/Isabella-Sticky-Note-Art",
              SITE_URL = "/MyArt/30/Isabella-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 31,
              URL = BASEPATH + "/MyArt/31/Olivia-Sticky-Note-Art",
              SITE_URL = "/MyArt/31/Olivia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 32,
              URL = BASEPATH + "/MyArt/32/Ava-Sticky-Note-Art",
              SITE_URL = "/MyArt/32/Ava-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 33,
              URL = BASEPATH + "/MyArt/33/Mia-Sticky-Note-Art",
              SITE_URL = "/MyArt/33/Mia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 34,
              URL = BASEPATH + "/MyArt/34/Kia-Sia-Sticky-Note-Art",
              SITE_URL = "/MyArt/34/Kia-Sia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 35,
              URL = BASEPATH + "/MyArt/35/Lily-Sticky-Note-Art",
              SITE_URL = "/MyArt/35/Lily-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 36,
              URL = BASEPATH + "/MyArt/36/Charlotte-Sticky-Note-Art",
              SITE_URL = "/MyArt/36/Charlotte-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 37,
              URL = BASEPATH + "/MyArt/37/Amelia-Sticky-Note-Art",
              SITE_URL = "/MyArt/37/Amelia-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 38,
              URL = BASEPATH + "/MyArt/38/Grace-Sticky-Note-Art",
              SITE_URL = "/MyArt/38/Grace-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
          ...
          {
              ID = 39,
              URL = BASEPATH + "/MyArt/39/Stella-Sticky-Note-Art",
              SITE_URL = "/MyArt/39/Stella-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              ...
              VIDEO = "",
              Desription = "<p class='Art-Detail-Text'>Welcome to the mesmerizing world of sticky note art, where creativity knows no bounds! In this post, we delve into the captivating drawings created by me. Prepare to be enchanted as we introduce you to Stella, a vibrant character who brings music and dance to life through my artistic vision.\n\nShe is a free-spirited girl with an infectious love for music and an eternal dance in her heart. Stella's radiant energy and perpetual motion make her the perfect muse for my drawing.\n</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='/MyWorkFlow-MyArtfulness'>MORE</a>] to step into a world where creativity dances with imagination. Where colors come alive. Art whispers its secrets.</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='https://opensea.io/KhizoOo_'>MORE</a>] to visit my OpenSea account.\n</p>",
              Type = "Art",
              Category = "Sticky Note",
         ...
         /*  new Art()
          {
              ID = 40,
              URL = BASEPATH + "/MyArt/40/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/43/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
              Title = "OOO",
              SubTitle = "Sticky Note - Art",
              IMG = "/images/MyArts/OOO.avif",
              VIDEO = "",
              Desription = "<p class='Art-Detail-Text'>OOO</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='/MyWorkFlow-MyArtfulness'>MORE</a>] to step into a world where creativity dances with imagination. Where colors come alive. Art whispers its secrets.</p><p class='Art-Detail-Text'>Visit [<a class='L-C' href='https://opensea.io/KhizoOo_'>MORE</a>] to visit my OpenSea account.\n</p>",
              Type = "Art",
              Category = "Sticky Note",
              CreatedOn = "6th JUNNNE 2023",
          ...
          {
              ID = 41,
              URL = BASEPATH + "/MyArt/41/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/41/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
          ...
          {
              ID = 42,
              URL = BASEPATH + "/MyArt/42/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/42/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
          ...
          {
              ID = 43,
              URL = BASEPATH + "/MyArt/43/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/43/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
          ...
          {
              ID = 44,
              URL = BASEPATH + "/MyArt/44/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/44/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
          ...
          {
              ID = 45,
              URL = BASEPATH + "/MyArt/45/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/45/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
          ...
          {
              ID = 46,
              URL = BASEPATH + "/MyArt/46/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/46/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
          ...
          {
              ID = 47,
              URL = BASEPATH + "/MyArt/47/OOO-Sticky-Note-Art",
              SITE_URL = "/MyArt/47/OOO-Sticky-Note-Art",
              Tags = "[\"Art\",\"Sticky-Note\",]",
              Slug = "OOO-Sticky-Note-Art",
              DataGroup = "[\"all\",\"stickynotes\"]",
              Heading = "OOO - Sticky Note - Art",
